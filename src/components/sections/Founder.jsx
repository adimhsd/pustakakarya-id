    ...
    return (
        <section className="py-20 bg-slate-50">
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-center gap-12 bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-slate-100">
                    ...
                    <div className="flex-1">
                        ...
                        <h2 className="text-3xl font-bold text-slate-900 mb-2">{FOUNDER_CONTENT.name}</h2>
                        <p className="text-blue-600 font-medium mb-6">{FOUNDER_CONTENT.role}</p>
