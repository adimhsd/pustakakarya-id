...
const About = () => {
    return (
        <section id="about" className="py-8 md:py-12 bg-white">
            <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-6 md:gap-10 items-center">
                <div>
                    ...
                    <div className="grid grid-cols-2 gap-6">
                        <div className="p-3 bg-blue-50 rounded-lg">
                            ...
                            <p className="text-sm text-slate-600 mt-1 text-balance justify-text">
